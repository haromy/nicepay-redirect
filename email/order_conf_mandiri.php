					...
					<table class="table" bgcolor="#ffffff" style="width:100%">
						<tr>
							<td align="center" class="logo" style="border-bottom:4px solid #333333;padding:7px 0">
								<a title="<?php echo $_POST["shop_name"]; ?>" href="{shop_url}" style="color:#337ff1">
									<img src="{shop_logo}" alt="<?php echo $_POST["shop_name"]; ?>" />
								</a>
							</td>
						</tr>
...
<tr>
	<td class="box" style="background-color:#fbfbfb;border:1px solid #d6d4d4!important;padding:10px!important">
		<p style="margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:18px;border-bottom:1px solid #d6d4d4!important;padding-bottom:10px">
			Anda telah memilih untuk membayar menggunakan Mandiri Virtual Account.
		</p>
		<span style="color:#777">
			Berikut adalah informasi pembayaran yang harus dilakukan :<br /> <br />
			<span style="color:#333">Jumlah Pembayaran : </span><strong><?php echo $_POST["amt"]; ?></strong><br />
...
<tr>
	<td class="box" style="background-color:#fbfbfb;border:1px solid #d6d4d4!important;padding:10px!important">
		...
		Silakan melakukan pembayaran dengan Bank Transfer <b>Mandiri (Virtual Account)</b> dengan mengikuti petunjuk berikut :<br/><br/>
		<b>ATM Mandiri</b><br/>
        <ol>
        ...
        <b>Internet Banking Mandiri</b><br/>
        <ol>
        ...
        <font color='red'>* 1 (satu) nomor Virtual Account hanya berlaku untuk 1 (satu) nomor order / pesanan</font>
    </td>
</tr>
...
<tr>
	<!-- <td class="linkbelow" style="padding:7px 0">
		<font size="2" face="Open-sans, sans-serif" color="#555454">
			<span>
				Anda dapat melihat pesanan dan mengunduh invoice dari <a href="{history_url}" style="color:#337ff1">"Riwayat pembelian"</a> melalui akun pelanggan Anda yang dapat diakses dihalaman <a href="{my_account_url}" style="color:#337ff1">"Akun saya"</a> diwebsite kami.
			</span>
		</font>
	</td> -->
</tr>
...
<tr>
	<!-- <td class="linkbelow" style="padding:7px 0">
		<font size="2" face="Open-sans, sans-serif" color="#555454">
			<span>
				Jika Anda menggunakan guest account, Anda dapat memantau pembelian Anda melalui halaman <a href="{guest_tracking_url}?id_order={order_name}" style="color:#337ff1">"Guest Tracking"</a> diwebsite kami.
			</span>
		</font>
	</td> -->
</tr>
						...
						<tr>
							<!-- <td class="footer" style="border-top:4px solid #333333;padding:7px 0">
								<span><a href="{shop_url}" style="color:#337ff1">{shop_name}</a> didukung oleh <a href="http://www.prestashop.com/" style="color:#337ff1">PrestaShop&trade;</a></span>
							</td> -->
						</tr>
					</table>
				</td>
